...
-------------------------------
1. **What is a Crypto-Equity?** A crypto-equity is a software program that runs on many different computers simultaneously around the world. Bitcoin was the first crypto-equity; today, there are hundreds. Crypto-equities typically are composed of some sort of tokens that can be traded from person to person; these trades are recorded in a public ledger called the blockchain.
...
4. **Why "Company?"** This is the key factor that sets DACs apart from 1st-generation crypto-equities like Bitcoin. Bitcoin is Decentralized and Autonomous, but since it does not generate income for its shareholders, it is not a DAC. 
...
BitShares
----------
1. **What is BitShares?** BitShares is the brand-name that Invictus Innovations gives to all of their DACs.
2. 
3. 
...
9. **What is the Social Consensus?** The Social Consensus is a concept pioneered by Invictus that states that developers of new DACs honor PTS (and AGS); i.e., that 10% of the total shares in any new DAC be apportioned to holders of PTS.
...
6. **What happens to my Bitcoin or PTS when I donate?** All donated funds are placed in an account that is used solely to advance the development of DACs. Invictus Innovations takes no profit from the AGS donation funds.
...
3. **What is the difference between BitShares X and XT?**  BitShares X is a family of DACs based on the decentralized exchange concept. Each one will have its own blockchain and different variations on the core idea. The "T" in BitShares XT stands for "Test"; it is the first DAC in the BitShares X family.
...
5. **How is BitUSD created?** Any BitShares XT user will be able to take out a loan of BitUSD using XTS as collateral. Suppose 1 XTS is worth 1 USD: If I have 10 XTS in my BitShares XT wallet, I can borrow up to 1 BitUSD using my XTS as collateral. I am then free to sell this BitUSD on the decentralized exchange.
6. **How is BitUSD destroyed?** If I borrow 1 BitUSD when the market price XTS is 1 USD, and then the market price of XTS falls so that I have 1.5 USD worth of XTS left; in other words, if I am at risk for not being able to repay the BitUSD I borrowed, then BitShares XT will re-possess enough of my XTS to cover the loan and charge me a 5% fee. This is known as a "margin call." The XTS that is confiscated will be given to whoever holds the BitUSD that I originally borrowed.
7. **How does BitUSD track the value of real-world USD?** The tracking is accomplished by the power of decentralized free markets. If BitUSD is ever worth more than real-world USD, people will expect its price to fall to the price of real-world USD, so they will borrow BitUSD and immediately sell it on the decentralized exchange. Then when the price falls, they can buy back their BitUSD cheaper than they sold it and profit.
